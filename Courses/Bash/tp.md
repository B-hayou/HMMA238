...
### <font color='red'>Exercise:</font>
   ...
   3. Use the `split` command and its options `-d` `-l` and `--additional-suffix` to create files with a maximum number of lines of 10000 (e.g. :if the number of lines is 55379, you should get only 6 files with names `bike00.csv`, ..., `bike06.csv`)
----
